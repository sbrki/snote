...
const $vimCheckBoxLabel = document.getElementById("vim-checkbox");
...
async function saveNote() {
  ...
  $saveButtonAnimator.classList.remove(
    "animate__animated",
    "animate__pulse",
  );

  // Crna magija da triggera reflow HTML-a (refresha stanje CSS animacija)
  void $saveButtonAnimator.offsetWidth;
...
editor.on("change", async () => {
  ...
  if ($saveButton.style.color !== "gray") {
